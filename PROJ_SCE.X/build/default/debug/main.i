...
DATAEE_WriteByte(150,0xaa);
DATAEE_WriteByte(151,PMON);
DATAEE_WriteByte(152,TALA);
DATAEE_WriteByte(153,ALAH);
DATAEE_WriteByte(154,ALAM);
DATAEE_WriteByte(155,ALAS);
DATAEE_WriteByte(156,ALAT);
DATAEE_WriteByte(157,ALAL);
DATAEE_WriteByte(158,ALAF);
DATAEE_WriteByte(159,CLKH);
DATAEE_WriteByte(160,CLKM);
...
void check_vars(){
uint8_t pass = DATAEE_ReadByte(150);

if (pass == 0xaa){
CSUM = DATAEE_ReadByte(161);
CSUM -= DATAEE_ReadByte(160);
CSUM -= DATAEE_ReadByte(159);
CSUM -= DATAEE_ReadByte(158);
CSUM -= DATAEE_ReadByte(157);
CSUM -= DATAEE_ReadByte(156);
CSUM -= DATAEE_ReadByte(155);
CSUM -= DATAEE_ReadByte(154);
CSUM -= DATAEE_ReadByte(153);
CSUM -= DATAEE_ReadByte(152);
CSUM -= DATAEE_ReadByte(151);

if (CSUM == 0){
PMON = DATAEE_ReadByte(151);
TALA = DATAEE_ReadByte(152);
ALAH = DATAEE_ReadByte(153);
ALAM = DATAEE_ReadByte(154);
ALAS = DATAEE_ReadByte(155);
ALAT = DATAEE_ReadByte(156);
ALAL = DATAEE_ReadByte(157);
ALAF = DATAEE_ReadByte(158);
CLKH = DATAEE_ReadByte(159);
CLKM = DATAEE_ReadByte(160);
}
}
return;
}
